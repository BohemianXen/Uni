...
"QTextEdit {background-color: rgb(39, 39, 52); color: white}")
        ...
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(-1, 0, 2771, 741))
        ...
        self.liveGridLayout.addItem(spacerItem20, 4, 0, 1, 5)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.gyroLivePlot.sizePolicy().hasHeightForWidth())
        self.gyroLivePlot.setSizePolicy(sizePolicy)
        self.gyroLivePlot.setMinimumSize(QtCore.QSize(1200, 300))
        self.gyroLivePlot.setMaximumSize(QtCore.QSize(1200, 300))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.accLivePlot.sizePolicy().hasHeightForWidth())
        self.accLivePlot.setSizePolicy(sizePolicy)
        self.accLivePlot.setMinimumSize(QtCore.QSize(1200, 300))
        self.accLivePlot.setMaximumSize(QtCore.QSize(1200, 300))
