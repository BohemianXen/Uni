...
class Ui_ConnectView(object):
    def setupUi(self, ConnectView):
        ...
        self.connectStackedWidget = QtWidgets.QStackedWidget(ConnectView)
        self.connectStackedWidget.setGeometry(QtCore.QRect(0, 0, 1601, 771))
        self.connectStackedWidget.setObjectName("connectStackedWidget")
        ...
        self.connectStackedWidget.addWidget(self.defaultView)
...
"QListWidget::item::hover {background-color: rgb(90, 90, 121); }")
        ...
        self.connectStackedWidget.addWidget(self.loggedInView)
    ...
    def retranslateUi(self, ConnectView):
        ...
        self.defaultLabel.setText(_translate("ConnectView", "Please Log In to connect to a GAIT device"))
        self.pushButton.setText(_translate("ConnectView", "Connect"))
        ...
        item.setText(_translate("ConnectView", "device1"))
        item = self.devicesListWidget.item(1)
        item.setText(_translate("ConnectView", "device2"))
        item = self.devicesListWidget.item(2)
        item.setText(_translate("ConnectView", "device3"))
        item = self.devicesListWidget.item(3)
        item.setText(_translate("ConnectView", "device4"))
