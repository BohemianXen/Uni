...
"QListWidget::item::hover {background-color: rgb(90, 90, 121); }")
        ...
        self.uploadStackedWidget.addWidget(self.loggedInView)
    ...
    def retranslateUi(self, UploadView):
        ...
        self.defaultLabel.setText(_translate("UploadView", "Please Log In and connect to a GAIT device to upload data"))
        self.pushButton.setText(_translate("UploadView", "Connect"))
        self.searchButton.setText(_translate("UploadView", "Search"))
        ...
        item.setText(_translate("UploadView", "device1"))
        item = self.devicesListWidget.item(1)
        item.setText(_translate("UploadView", "device2"))
        item = self.devicesListWidget.item(2)
        item.setText(_translate("UploadView", "device3"))
        item = self.devicesListWidget.item(3)
        item.setText(_translate("UploadView", "device4"))
