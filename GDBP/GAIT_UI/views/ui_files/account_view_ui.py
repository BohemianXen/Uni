...
class Ui_AccountView(object):
    def setupUi(self, AccountView):
        ...
        self.accountStackedWidget = QtWidgets.QStackedWidget(AccountView)
        self.accountStackedWidget.setGeometry(QtCore.QRect(0, 0, 1601, 771))
        self.accountStackedWidget.setObjectName("accountStackedWidget")
        ...
        self.accountStackedWidget.addWidget(self.defaultView)
...
"QListWidget::item::hover {background-color: rgb(90, 90, 121); }")
        ...
        self.accountStackedWidget.addWidget(self.loggedInView)
    ...
    def retranslateUi(self, AccountView):
        ...
        self.defaultLabel.setText(_translate("AccountView", "Please Log In to view account details"))
        self.pushButton.setText(_translate("AccountView", "Connect"))
        self.searchButton.setText(_translate("AccountView", "Search"))
        ...
        item.setText(_translate("AccountView", "device1"))
        item = self.devicesListWidget.item(1)
        item.setText(_translate("AccountView", "device2"))
        item = self.devicesListWidget.item(2)
        item.setText(_translate("AccountView", "device3"))
        item = self.devicesListWidget.item(3)
        item.setText(_translate("AccountView", "device4"))
