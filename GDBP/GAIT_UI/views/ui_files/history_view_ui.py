...
"")
        ...
        self.dailyRadioButton.setEnabled(True)
        self.dailyRadioButton.setChecked(False)
        ...
        self.weeklyRadioButton.setEnabled(True)
        ...
        self.monthlyRadioButton.setEnabled(True)
        ...
        self.metricsComboBox = QtWidgets.QComboBox(self.layoutWidget)
        self.metricsComboBox.setEnabled(True)
        self.metricsComboBox.setMinimumSize(QtCore.QSize(400, 30))
        self.metricsComboBox.setMaximumSize(QtCore.QSize(400, 20))
        self.metricsComboBox.setObjectName("metricsComboBox")
        ...
        self.metricsComboBox.addItem("")
        self.metricsComboBox.addItem("")
        self.historyGridLayout.addWidget(self.metricsComboBox, 0, 2, 1, 1, QtCore.Qt.AlignRight)
        spacerItem1 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        self.historyGridLayout.addItem(spacerItem1, 0, 3, 7, 1)
        ...
        self.historyGridLayout.addItem(spacerItem2, 1, 0, 1, 3)
        spacerItem3 = QtWidgets.QSpacerItem(20, 30, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.historyGridLayout.addItem(spacerItem3, 0, 0, 1, 2)
        ...
        self.graphicsView = PlotWidget(self.graphView)
        self.graphicsView.setGeometry(QtCore.QRect(0, 0, 1128, 596))
        self.graphicsView.setObjectName("graphicsView")
        self.stackedWidget.addWidget(self.graphView)
        self.labelView = QtWidgets.QWidget()
        self.labelView.setObjectName("labelView")
        self.stackedWidget.addWidget(self.labelView)
        self.historyGridLayout.addWidget(self.stackedWidget, 2, 2, 4, 1)
        self.statsGroupBox = QtWidgets.QGroupBox(self.layoutWidget)
        self.statsGroupBox.setObjectName("statsGroupBox")
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(self.statsGroupBox)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(0, 20, 401, 321))
        ...
        self.historyGridLayout.addWidget(self.statsGroupBox, 5, 1, 2, 1)
        spacerItem4 = QtWidgets.QSpacerItem(20, 60, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.historyGridLayout.addItem(spacerItem4, 6, 0, 1, 1)
        spacerItem5 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.historyGridLayout.addItem(spacerItem5, 5, 0, 1, 1)
        spacerItem6 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.historyGridLayout.addItem(spacerItem6, 2, 0, 3, 1)
    ...
    def retranslateUi(self, HistoryView):
        ...
        self.metricsComboBox.setItemText(0, _translate("HistoryView", "Steps"))
        self.metricsComboBox.setItemText(1, _translate("HistoryView", "Running"))
        self.metricsComboBox.setItemText(2, _translate("HistoryView", "Heart Rate"))
        self.metricsComboBox.setItemText(3, _translate("HistoryView", "UV Exposure"))
        self.metricsComboBox.setItemText(4, _translate("HistoryView", "Pollution"))
        self.metricsComboBox.setItemText(5, _translate("HistoryView", "Location"))
        self.statsGroupBox.setTitle(_translate("HistoryView", "Stats"))
