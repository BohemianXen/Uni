...
class Ui_HistoryView(object):
    def setupUi(self, HistoryView):
        ...
        self.historyStackedWidget = QtWidgets.QStackedWidget(HistoryView)
        self.historyStackedWidget.setGeometry(QtCore.QRect(0, 0, 1601, 771))
        self.historyStackedWidget.setObjectName("historyStackedWidget")
        ...
        self.historyStackedWidget.addWidget(self.defaultView)
...
"QListWidget::item::hover {background-color: rgb(90, 90, 121); }")
        ...
        self.historyStackedWidget.addWidget(self.loggedInView)
    ...
    def retranslateUi(self, HistoryView):
        ...
        self.defaultLabel.setText(_translate("HistoryView", "Please Log In to view past performance data"))
        self.pushButton.setText(_translate("HistoryView", "Connect"))
        self.searchButton.setText(_translate("HistoryView", "Search"))
        ...
        item.setText(_translate("HistoryView", "device1"))
        item = self.devicesListWidget.item(1)
        item.setText(_translate("HistoryView", "device2"))
        item = self.devicesListWidget.item(2)
        item.setText(_translate("HistoryView", "device3"))
        item = self.devicesListWidget.item(3)
        item.setText(_translate("HistoryView", "device4"))
