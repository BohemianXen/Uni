...
class Ui_DeviceView(object):
    def setupUi(self, DeviceView):
        ...
        self.deviceStackedWidget = QtWidgets.QStackedWidget(DeviceView)
        self.deviceStackedWidget.setGeometry(QtCore.QRect(0, 0, 1601, 771))
        ...
        self.deviceStackedWidget.addWidget(self.defaultView)
...
"QListWidget::item::hover {background-color: rgb(90, 90, 121); }")
        ...
        self.deviceStackedWidget.addWidget(self.loggedInView)
    ...
    def retranslateUi(self, DeviceView):
        ...
        self.defaultLabel.setText(_translate("DeviceView", "Please Log In to manage a GAIT device"))
        self.pushButton.setText(_translate("DeviceView", "Connect"))
        self.searchButton.setText(_translate("DeviceView", "Search"))
        ...
        item.setText(_translate("DeviceView", "device1"))
        item = self.devicesListWidget.item(1)
        item.setText(_translate("DeviceView", "device2"))
        item = self.devicesListWidget.item(2)
        item.setText(_translate("DeviceView", "device3"))
        item = self.devicesListWidget.item(3)
        item.setText(_translate("DeviceView", "device4"))
